      ...
      <header className="border-b ink-rule">
        <div className="mx-auto max-w-6xl px-5 py-4 flex items-center justify-between">
          ...
          <nav className="hidden sm:flex items-center gap-5 text-sm">
            <a href="#simulation" className="hover:underline underline-offset-4">
              Simulation
            </a>
            <a href="#method" className="hover:underline underline-offset-4">
              Method
            </a>
            <a href="#results" className="hover:underline underline-offset-4">
              Results
            </a>
          </nav>
        </div>
        ...
        <div className="relative mx-auto max-w-6xl px-5 py-16 sm:py-24 grid lg:grid-cols-12 gap-10">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
              ...
              <span className="italic text-[color:var(--accent-academic)]"> & Control</span> using
              Reinforcement Learning.
            </h1>
            <p className="text-base sm:text-lg text-muted-foreground max-w-2xl leading-relaxed">
              A 4-way urban intersection where a tabular{" "}
              <span className="font-mono text-ink">Q-learning</span> agent decides — every few ticks
              — whether to <em>hold</em> the current signal phase or <em>switch</em>. The reward
              signal punishes waiting cars; the agent gradually discovers a smarter policy than a
              fixed-timer baseline. Toggle between the two below and watch the metrics diverge.
            </p>
          ...
          <aside className="lg:col-span-5 border ink-rule rounded-lg bg-paper p-5 space-y-3 self-start">
            ...
            <p className="text-sm leading-relaxed">
              Urban congestion is fundamentally a sequential decision problem. We model a signalized
              intersection as a Markov Decision Process and train a value-based reinforcement
              learning agent to minimise cumulative vehicle waiting time. The system is implemented
              as a multi-agent traffic controller, demonstrated here in a fully reproducible browser
              environment with no server backend.
            </p>
        ...
        <div className="mx-auto max-w-6xl px-5 py-14">
          <div className="flex items-end justify-between gap-4 mb-6 flex-wrap">
            ...
            <p className="text-sm text-muted-foreground max-w-md">
              Cars spawn from each direction with asymmetric arrival rates. Watch the Q-table grow
              and ε decay as the policy improves.
            </p>
          </div>
          <SimulationPanel />
        </div>
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="border ink-rule rounded-md p-5 bg-paper">
              ...
              <p className="text-sm mt-2 leading-relaxed">
                ...
                <span className="font-mono text-xs">s = ⟨b_N, b_S, b_E, b_W, φ⟩</span> with at most{" "}
                <span className="font-mono">5⁴ × 2 = 1250</span> entries — small enough for a
                tabular Q-function.
              </p>
            </div>
            <div className="border ink-rule rounded-md p-5 bg-paper">
              ...
              <p className="text-sm mt-2 leading-relaxed">
                The agent chooses <span className="font-mono text-xs">a ∈ {"{KEEP, SWITCH}"}</span>{" "}
                every 20 ticks, subject to a minimum-phase safety constraint. The reward at decision
                step <span className="font-mono text-xs">t</span> is{" "}
                <span className="font-mono text-xs">r_t = −|waiting| − 0.5·𝟙[a = SWITCH]</span>,
...
α = 0.1   γ = 0.9   ε: 1.0 → 0.05  (decay 0.9995/step)`}
            ...
            <div className="border ink-rule rounded-md p-5 bg-paper">
              ...
              <p className="text-sm mt-2 leading-relaxed">
                The architecture generalises: each intersection in a city grid runs an independent
                Q-learner observing only its own queues — a{" "}
                <em>decentralised, partially-observable</em> setting. Coordination emerges from
                shared traffic flow rather than explicit communication, the same paradigm used in
                IDQN and MA2C literature.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="results" className="border-b ink-rule">
        <div className="mx-auto max-w-6xl px-5 py-14">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl mt-3">
            ...
            <span className="font-mono text-xs">avg wait</span> on the asymmetric arrival pattern (E
            lane is busiest).
          </p>
